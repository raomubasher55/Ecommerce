...
const CategoryProducts = () => {
  ...
  return (
    <Layout>
      <div className='pt-24'>
        <div className='text-center' ><h1 className='font-bold text-2xl' >Category : {category.map((c , index)=>(c.name))} </h1></div>
        <div className='text-center' ><h1 className='font-bold text-lg' > Products : {categoryProducts.length} </h1></div>
        <div className='flex'>
