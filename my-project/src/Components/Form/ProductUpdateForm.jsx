...
const ProductUpdateForm = () => {
    ...
    const { updateProduct, singleProduct, deleteProduct } = useProduct();
    ...
    useEffect(() => {
        if (singleProduct) {
            ...
            setShipping(singleProduct.shipping ? '1' : '0');
    ...
    const handleImageUpload = (e) => {
        ...
        if (file) {
            setProduct({ ...product, image: file })       //backend me direct file  ka path send  hoti h
            //          <--enough for backend--->
    ...
    const handleOnDelete = async () => {
        const answer = window.prompt('Are you sure  want to delete this product ?  If yes Write "Yes".')
        if(!answer) return
            ...
            <form onSubmit={handleOnSubmit}>
                <div className='grid grid-cols-3'>
                    <div
                        ...
                        tabIndex="-1"
                        aria-hidden="true"
                        className=" overflow-y-auto overflow-x-hidden  col-span-2  justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
                    >
                                ...
                                <div className="p-4 md:p-5">
                                    <div className="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div className="col-span-2 sm:col-span-1">
                                            ...
                                            <Select className='w-full custom-select no-border' name='category' placeholder='Select the Category' size='large' showSearch onChange={(value) => { setCategory(value) }} value={category} >
                                        ...
                                        <div className="col-span-2 sm:col-span-1">
                                            ...
                                            <Select className='w-full custom-select no-border' allowClear required name='shipping' variant='filled' placeholder='Select Shipping' size='large' showSearch onChange={(value) => { setShipping(value === '1') }} value={shipping ? "Yes" : "No"} >
                                    ...
                                    <div className='flex gap-20'>
                                        ...
                                        <button onClick={handleOnDelete} type="button" className=" text-white inline-flex items-center bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg className="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd"></path></svg>
                                            Delete product
                                        </button>
                                    </div>
