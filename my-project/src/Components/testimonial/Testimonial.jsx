         ...
         <div>
            <section className="text-gray-600 body-font mb-10">
                ...
                <div className="container px-5 py-10 mx-auto">
                    {/* Heading  */}
                    <h1 className=' text-center text-3xl font-bold text-black mb-5' >Love by the Customer</h1>
                    {/* para  */}
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Rao Mubasher</h2>
