...
const ResponsiveUserMenu = ({toggleOnUserMenu}) => {
  ...
  }, [menuRef, toggleOnUserMenu]);
  return (
    <>
      <div ref={menuRef} className="w-[40%] pt-8 ml-3 pr-6 md:p-4 min-h-screen  Shadow absolute bg-white" >
        <div className='text-xl flex flex-row-reverse' onClick={()=>toggleOnUserMenu(false)} ><IoCloseSharp /> </div>
                <div className="">
