...
const ResponsiveAdminMenu = ({toggleAdminMenu}) => {
  ...
  }, [menuRef, toggleAdminMenu]);



  return (
    <>
           <div ref={menuRef} className="w-[40%] pt-8 ml-3 pr-6 md:p-4 min-h-screen  Shadow absolute z-10 bg-white">
           <div className='text-xl flex flex-row-reverse z-10' onClick={()=>toggleAdminMenu(false)} ><IoCloseSharp  /> </div>
                <div className="   ">
